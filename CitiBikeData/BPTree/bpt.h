...
public:
    ...
    int sortOrderAscending(value_t *values, size_t max, bool *next = NULL) const;
    int sortOrderDescending(value_t *values, size_t max, bool *next = NULL) const;
    off_t lastLeafOffset() const;
